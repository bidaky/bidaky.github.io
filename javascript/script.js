...
First_next_button.addEventListener('click', function (event) {
...
next_buttonFirst.addEventListener('click', function (event) {
    event.preventDefault();
...
next_buttonSecond.addEventListener('click', function (event) {
    event.preventDefault();
...
prev_buttonFirst.addEventListener('click', function (event) {
    event.preventDefault();
...
prev_buttonSecond.addEventListener('click', function (event) {
    event.preventDefault();
    slidePage.style.marginLeft = '-25%';
    RegBlock[current-2].classList.remove('active');
    progress[current-2].classList.remove('active');
...
prev_buttonThird.addEventListener('click', function (event) {
    event.preventDefault();
    slidePage.style.marginLeft = '-50%';
    RegBlock[current-2].classList.remove('active');
    progress[current-2].classList.remove('active');
